...
Dockerized Full Stack Application using Spring boot, React, Redux, Material-ui and Docker.
...
1. Clone the project to your local environment:
    ```
    git clone https://github.com/ankitrajput0096/FullStack_Dockerized_Application
    ```
